...
func (a *app) renderShell(w http.ResponseWriter, r *http.Request, d shellData, content template.HTML) {
	...
	if d.Slug != "" {
		...
		d.Items = []navItem{{"projects", "Projects", "/", "grid"}, {"people", "Team", "/people", "user"}, {"audit", "Audit log", "/audit", "list"}, {"guide", "Guide", "/docs", "book"}, {"system", "System", "/system", "database"}, {"account", "Account", "/account", "settings"}}
	}
